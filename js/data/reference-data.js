...
async function loadWHOPercentileData() {
    ...
    try {
        ...
        WHO_PERCENTILE_DATA.boys = await boysResponse.json();
        WHO_PERCENTILE_DATA.girls = await girlsResponse.json();
        WHO_PERCENTILE_DATA.loaded = true;
        
        console.log('✅ WHO persentil verileri yüklendi:', {
            boys: WHO_PERCENTILE_DATA.boys.length + ' kayıt',
            girls: WHO_PERCENTILE_DATA.girls.length + ' kayıt'
        });
...
// WHO and Neyzi Reference Data - Complete Integration
const REFERENCE_DATA = {
    // WHO Male (Erkek) Reference Data
    who_male: {
        weight: [
    ...
    who_female: {
        ...
        bmi: [
            ...
            { age: '12', months: 144, p5: 12.8, p10: 13.9, p25: 14.9, p50: 16.6, p75: 18.9, p85: 20.7, p95: 23.8 },
    ...
    // Neyzi Female (Kız) Reference Data
    neyzi_female: {
        weight: [
            { age: 'Doğum', months: 0, p3: 2.52, p10: 2.76, p25: 3.01, p50: 3.29, p75: 3.58, p90: 3.84, p97: 4.10 },
            { age: '3 ay', months: 3, p3: 4.48, p10: 4.90, p25: 5.33, p50: 5.82, p75: 6.32, p90: 6.78, p97: 7.24 },
